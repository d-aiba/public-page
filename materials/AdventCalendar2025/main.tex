...
\begin{definition}[クライスリ圏]
	$T:\C\to\C$ を、圏 $\C$ 上の自己関手とする。モナド $(T,\eta,\mu)$ が与えられたとき、以下で定められた圏 $\C_T$ を、\textbf{クライスリ圏} (Kleisli category) と呼ぶ。
	% （なお $\Kl(T)$ と表記することもある。）
	\begin{itemize}
...
\begin{definition}[EM圏]
	$T:\C\to\C$ を、圏 $\C$ 上の自己関手とする。モナド $(T,\eta,\mu)$ が与えられたとき、以下で定められた圏 $\C^T$ を、\textbf{アイレンバーグ・ムーア圏} (Eilenberg-Moore category) と呼ぶ。
...
\noindent ※ 両者のアプローチ (1) $\gamma:X\to \mathcal P(L\times X)$ と (2) $\gamma:X\to \mathcal P(X)^{L}$ は、同じもの（見方を変えただけ）です。\vspace{5pt}%\\
% \small 
\begin{small}
\begin{prooftree}
	...
	\begin{multicols}{2}
		...
		\begin{align*}
			\begin{array}{ccc}
				...
				\substack{\displaystyle X\\\rotatebox{-90}{$\!\textstyle\computationlongrightarrow$\;}\\\displaystyle Y}  & \longmapsto & \begin{array}{c} FX \\ ~~~ \downarrow \substack{Ff} \\ FTY \\ ~~~\downarrow \substack{\lambda_Y} \\ TFY \end{array}
			\end{array}
		\end{align*}
