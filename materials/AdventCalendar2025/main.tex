...
\begin{itemize}
	...
	\[\begin{array}{ccc}\Hom_{\C}(X,R^TF^TL^TX) & \cong & \Hom_{\C^T}(L^TX,F^TL^TX)\\ \rotatebox{90}{$\in$}&&\rotatebox{90}{$\in$}\\ \gamma && \textrm{its underlying map is $\gamma^\sharp$}\end{array}\]
	% \item 
	% \item 
	% \item 
