...
$\mu f$ は、以下の図に見られるような$2^X$における鎖の、超限反復 (transfinite iteration) によって構成されます。
\begin{center}
	\begin{small}
...
\noindent 以下、ファイブレーションの正確な定義を念のため書いておきます。（ですが、上記の $p\colon\Pred\to\Set$ の考え方だけをきちんと押さえておけば、次節以降の内容を理解するうえでほとんど問題はありません。）
