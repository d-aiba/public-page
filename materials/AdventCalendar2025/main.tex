...
ここでクイズです。クライスリ圏の直積がモノイダルになるのはどんなときでしょうか？ 答えは、$T$ が可換な強モナドであるときです！ すなわち、二重ストレングス $T(X)\otimes T(Y)\to T(X\otimes Y)$ があるとき、クライスリ圏 $\C_T$ はモノイダルになります。（つまり、ストリング図式で書ける！）
\begin{align*}
	\begin{array}{cccccc}
