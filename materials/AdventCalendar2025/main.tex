...
\subsection{余談: 計算効果 (computational effect) について}
...
以下では、「モナド」と「クライスリ圏」をそれぞれ導入します。（これらの概念そのものは後の章で直接的に使うわけではありませんが、これらの考え方が後の章を理解するうえで役立つという意図で、本節を設けています。これらを念頭に置くことで、次章の背後にある問題設定や動機づけをより明確に理解できるようになるはずです。）
