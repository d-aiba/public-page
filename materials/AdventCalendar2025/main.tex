...
いま、$\C$ をカルテシアン閉圏とし、$T:\C\to\C$ を、左ストレングス $str_{X,Y}^L:X\otimes T(Y)\to T(X\otimes Y)$ と右ストレングス $str_{X,Y}^R:T(X)\otimes Y\to T(X\otimes Y)$ を持つモナドとします。このとき、クライスリ圏 $\C_T$ は
\begin{itemize}
...
\end{center}
は、\kenten{どちらの射を先に適用するかに依存}しています。というのも、
\begin{align*}
...
\end{align*}
の両者は異なります。このように、クライスリ圏における直積は、射を適用する順番に敏感なのです。\vspace{6pt}
