...
\noindent まずは、この「モナド分配則」を具体的にどうやって使うかを、以下ではオートマトンの例を挙げて説明します。\vspace{-10pt}
...
\begin{itemize}
	...
	この $TX\to F(TX)$ を得る過程は、まさに「\textgt{冪集合構成}」(powerset construction) に相当します。\\
	詳しく言うと、以下の合成を通じて、
	\begin{center}
		\begin{tikzcd}[row sep=12pt]
...
\begin{proposition}
	クライスリ圏とEM圏について、それぞれ、以下の自由忘却随伴が知られている。（証明略） %(free-forgetful adjunction) 
	\begin{multicols}{2}
		\begin{center}
...
\begin{itemize}
	...
	\end{multicols}
	\noindent 
	のように、$\gamma$ から $\gamma^\sharp$ が一意に得られます。
