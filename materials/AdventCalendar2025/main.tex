...
$\omega+1$よりもさらも先で安定 (stabilize) する例もあります。分岐がもっと複雑なものを考えればよいのです。たとえば、以下のようなクリプキフレームを考えてみましょう。この場合、$\omega+2$で安定します。
\vspace{8pt}
%
\begin{multicols}{2} %%%
	\begin{center}
...
% \end{small}
% \end{center}\vspace{8pt}
さらに、（上記の略記を用いて）もっと複雑なものを考えてみます。たとえば、以下の図のクリプキフレームを考えましょう。この場合、$2\omega+1$ で安定します。
\vspace{8pt}
\begin{center}
\begin{small}
