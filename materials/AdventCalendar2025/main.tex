...
\noindent なお「劣分布」とは、遷移確率が$1$\kenten{以下}である確率分布のことです。たとえば「$x_0$から、確率$0.4$で$x_1$に遷移し、確率$0.3$で$x_2$に遷移し、それ以外は異常停止 (deadlock) する」といったものです。（これは理論的にも便利で、sub-distribution の集合は $\omega$-cpo になります。）%\vspace{10pt}
